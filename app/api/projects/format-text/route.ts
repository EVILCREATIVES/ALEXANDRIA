...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = `You are a document formatting assistant. The following text was extracted from a scanned PDF with page markers already included (like "--- Page 1 ---").

Please reformat this text:
...
6. PRESERVE all page markers exactly as they appear (--- Page X ---)
7. Keep page markers on their own line

Return ONLY the reformatted text with page markers preserved, no explanations.
